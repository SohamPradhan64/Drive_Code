...
//mogo mech, intake code, ramp pistons, stop brakes, autonomous, user control
...
motor Ramp = motor(PORT7, ratio6_1, false);
motor Push_ramp1 = motor(PORT9, ratio18_1, false);
motor Push_ramp2 = motor(PORT10, ratio18_1, false);
